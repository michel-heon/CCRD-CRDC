# Canadian Research and Development Classification  (CRDC) Ontology for the Linked Open Data 
voir: [see english description](./README_en.md)

# Ontologie de le "Classification Canadienne de la Recherche et Développement (CCRD)" pour le web de données liées et ouvertes
